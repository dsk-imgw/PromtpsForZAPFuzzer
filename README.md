...
- ペイロードの網羅性を求めるのであれば、商用ツールを購入したり、[garak](https://github.com/leondz/garak) や [PyRIT](https://github.com/Azure/PyRIT) などの他のオープンソース スキャナーを利用したり、左記のオープンソース スキャナーのペイロードを流用したりする必要がある。
